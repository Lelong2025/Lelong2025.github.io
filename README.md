...
3. Chạy `database/vip-credits.sql` để chuyển VIP trả phí sang cơ chế lượt dùng: thanh toán gói sẽ cộng lượt, nạp số dư sẽ cộng tiền vào ví, mỗi tin nhắn AI ưu tiên trừ lượt và khi hết lượt sẽ tự trừ số dư theo đơn giá admin cấu hình.
