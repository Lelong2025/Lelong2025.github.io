...
import {
    ...
    deleteSelectedTable, insertDraftRowAbove, insertDraftRowBelow, insertDraftColumnLeft,
    insertDraftColumnRight, deleteDraftRow, deleteDraftColumn, distributeDraftColumns,
    distributeDraftRows, deleteDraftTableFromArticle, switchTableBuilderTab,
...
Object.assign(window, {
    ...
    insertDraftRowAbove,
    insertDraftRowBelow,
    insertDraftColumnLeft,
    insertDraftColumnRight,
    deleteDraftRow,
    deleteDraftColumn,
    distributeDraftColumns,
    distributeDraftRows,
    deleteDraftTableFromArticle,
    switchTableBuilderTab,
    mergeCellRight,
    mergeCellDown,
    splitActiveCell,
    addTableRow,
